...
import { ConstructionIssue } from './types/construction-issue.js';
...
export class CSVIssueChat {
  ...
  public issues: ConstructionIssue[] = [];
  private context = '';
  ...
  async loadCSV(csvPath: string) {
    return new Promise<void>(async (resolve, reject) => {
      this.issues = await generateArrayFromCSV<ConstructionIssue>(csvPath, constructionIssueSchema);
